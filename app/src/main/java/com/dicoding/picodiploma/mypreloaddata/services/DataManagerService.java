...
public class DataManagerService extends Service {
    ...
    // memanggil LoadDataAsync di kelas DataManagerService
    @Override
    ...
    // membuat variabel dari LoadDataCallback untuk merima, mengirim kembalian data ke activity pemanggil
    LoadDataCallback myCallback = new LoadDataCallback() {
        ...
        @Override
        public void onProgresUpdate(long progress) {
            try {
